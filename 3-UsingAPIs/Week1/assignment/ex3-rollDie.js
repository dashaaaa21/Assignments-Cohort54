...
// Now rollDie() uses a promise. This is better because it is clear and safe
// If the die rolls off the table, reject() sends an error
// If the die finishes rolling, resolve() sends the value
// The problem from the old callback version does not happen anymore
